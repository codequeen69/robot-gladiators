...
var fight = function (enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
        if (isPlayerTurn) {
            ///ask if player if they'd like to fight or skip using fightOrSkip function
            if (fightOrSkip()) {
...
var endGame = function () {
    ...
    if(playerInfo.money> highScore){
        ...
        alert(playerInfo.name + " did not beat the high score if" + highscore + ". Maybe next time!");
    }
...
var shop = function () {
    ...
    //convert answer from prompt from a string to an actual number
